...
function main {
	...
	then
		...
		test_marketplace_products_check_marketplace_products_compatibility
...
function test_marketplace_products_check_marketplace_products_compatibility {
...
function test_marketplace_products_get_latest_product_virtual_settings_file_entry_json_index {
	...
	_test_marketplace_products_get_latest_product_virtual_settings_file_entry_json_index "empty_version" ""
}

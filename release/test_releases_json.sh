...
function test_releases_json_add_database_schema_versions {
	git -C "${_PROJECTS_DIR}/liferay-portal-ee" fetch upstream 2025.q2.1 &> /dev/null

	git -C \
		"${_PROJECTS_DIR}/liferay-portal-ee" show "refs/tags/2025.q2.1:portal-impl/src/com/liferay/portal/upgrade/v7_4_x/PortalUpgradeProcessRegistryImpl.java" > \
